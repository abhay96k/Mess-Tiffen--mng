        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          {isSignUp ? (
            <motion.button
              ...
              disabled={loading}
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 btn-emerald-glow text-white font-extrabold select-none mt-1 flex items-center justify-center gap-2 text-sm tracking-wide shadow-2xl"
            >
